...
public class XWikiWysiwygEditorApi extends WysiwygEditorApi
{
    ...
    {
        return XWikiWysiwygEditorFactory.getInstance();
    }
    ...
    /*-{
        ...
        $wnd.WysiwygEditor = function(config) {
            if (typeof config == 'object') {
                this.instance = @org.xwiki.gwt.wysiwyg.client.XWikiWysiwygEditorApi::new(Lorg/xwiki/gwt/dom/client/JavaScriptObject;)(config);
            }
        }
